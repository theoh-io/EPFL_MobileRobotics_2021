...
state = 1          # 0=global path, 1=obstacle avoidance
obst = [0,0,0]     # measurements from left middle right prox sensors
    
timer_period[0] = 10   # 10ms sampling time
obstThrL = 5      # low obstacle threshold to switch state 1->0
obstThrH = 60      # high obstacle threshold to switch state 0->1  
